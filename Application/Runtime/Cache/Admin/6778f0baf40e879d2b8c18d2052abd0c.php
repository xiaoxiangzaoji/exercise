...
<dl>
 ...
 <dd>
 <ul>
  <li><a href="<?php echo U('Admin/Good/goodslist');?>" target="main">商品列表</a></li>
  ...
  <li><a href="<?php echo U('Admin/Good/huishou');?>" target="main">商品回收站</a></li>
  <li><a href="<?php echo U('Admin/Customer/stock');?>" target="main">库存管理</a></li>
 </ul>
 </dd>
 <dt><a href="#"><i class="  icon-list-alt"></i>订单管理</a></dt>
 <dd>
 <ul>
  <li><a href="<?php echo U('Admin/Order/orderinfo');?>" target="main">订单列表</a></li>
  <li><a href="#">合并订单</a></li>
  <li><a href="#">订单打印</a></li>
  <li><a href="#">添加订单</a></li>
